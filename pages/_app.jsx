...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=845347669227470858&permissions=40581035584592&scope=bot%20applications.commands",
    },
       {
      link: true,
      name: "Votar",
      ...
      href: "https://top.gg/bot/845347669227470858/vote",
    },
    {
      link: true,
      name: "Parceiros",
